...
class GoodsDriverRechargeHomeScreen extends StatefulWidget {
  const GoodsDriverRechargeHomeScreen({super.key});

  @override
  State<GoodsDriverRechargeHomeScreen> createState() =>
      _GoodsDriverRechargeHomeScreenState();
}

class _GoodsDriverRechargeHomeScreenState
    extends State<GoodsDriverRechargeHomeScreen> {
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        ...
                        print(
                            "point which i will get after this recharge::${allRechargesModel[index].points}");
