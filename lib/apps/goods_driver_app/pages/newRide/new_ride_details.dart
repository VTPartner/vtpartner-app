...
class GoodsRiderNewRideDetails extends StatefulWidget {
  const GoodsRiderNewRideDetails({super.key});

  @override
  State<GoodsRiderNewRideDetails> createState() =>
      _GoodsRiderNewRideDetailsState();
}

class _GoodsRiderNewRideDetailsState extends State<GoodsRiderNewRideDetails> {
