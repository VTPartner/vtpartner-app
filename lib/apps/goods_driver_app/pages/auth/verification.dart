...
class GoodsDriverVerificationScreen extends StatefulWidget {
  const GoodsDriverVerificationScreen({super.key});

  @override
  State<GoodsDriverVerificationScreen> createState() =>
      _GoodsDriverVerificationScreenState();
}

class _GoodsDriverVerificationScreenState
    extends State<GoodsDriverVerificationScreen> {
