...
class GoodsDriverRechargeHistoryScreen extends StatefulWidget {
  const GoodsDriverRechargeHistoryScreen({super.key});

  @override
  State<GoodsDriverRechargeHistoryScreen> createState() =>
      _GoodsDriverRechargeHistoryScreenState();
}

class _GoodsDriverRechargeHistoryScreenState
    extends State<GoodsDriverRechargeHistoryScreen> {
