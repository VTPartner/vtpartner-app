...
class JcbWorkLocationSearchScreen extends StatefulWidget {
  const JcbWorkLocationSearchScreen({super.key});

  @override
  State<JcbWorkLocationSearchScreen> createState() =>
      _JcbWorkLocationSearchScreenState();
}

class _JcbWorkLocationSearchScreenState
    extends State<JcbWorkLocationSearchScreen> {
  ...
  Future<void> _getUserLocationAndAddress() async {
    ...
    try {
      ...
      Navigator.pushNamed(context, JcbCraneAppWorkLocationMapRoute);
    } catch (e) {}
  }
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: "Where is the ${glb.subCategoryName} needed?",
...
//https://developers.google.com/maps/documentation/places/web-service/details#json
                        if (responseApi["status"] == "OK") {
                          ...
                          Navigator.pushNamed(
                              context, JcbCraneAppWorkLocationMapRoute);
                        } else {
                          if (kDebugMode) {
