...
class JcbWorkMapLocationScreen extends StatefulWidget {
  const JcbWorkMapLocationScreen({super.key});

  @override
  State<JcbWorkMapLocationScreen> createState() =>
      _JcbWorkMapLocationScreenState();
}

class _JcbWorkMapLocationScreenState extends State<JcbWorkMapLocationScreen> {
                  ...
                  children: [
                    ...
                    _showBottomSheet
                        ? Positioned(
                            ...
                            child: CustomTooltip(
                                message: 'This is the Work Location'))
                        : SizedBox(),
                    SafeArea(
                      child: Padding(
  ...
  savePickupLocationDetails() async {
    ...
    if (_latitude != 0.0 || _longitude != 0.0) {
      ...
      glb.showSnackBar(context,
          "No online JCB or Crane drivers are currently available near your work location.");
    } else {
      print("LatLng Error");
    }
  }
