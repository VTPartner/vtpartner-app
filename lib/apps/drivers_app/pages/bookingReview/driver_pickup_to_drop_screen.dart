...
class DriverPickupToDropLocationsScreen extends StatefulWidget {
  const DriverPickupToDropLocationsScreen({super.key});

  @override
  State<DriverPickupToDropLocationsScreen> createState() =>
      _DriverPickupToDropLocationsScreenState();
}

class _DriverPickupToDropLocationsScreenState
    extends State<DriverPickupToDropLocationsScreen> {
  var isLoading = false;
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          glb.showSnackBar(context,
                              "Unfortunately, there are no available drivers near your starting location at the moment.");
                        },
                        child: Ink(
                          decoration: BoxDecoration(
