...
class DriverPickupLocationSearchScreen extends StatefulWidget {
  const DriverPickupLocationSearchScreen({super.key});

  @override
  State<DriverPickupLocationSearchScreen> createState() =>
      _DriverPickupLocationSearchScreenState();
}

class _DriverPickupLocationSearchScreenState
    extends State<DriverPickupLocationSearchScreen> {
  ...
  Future<void> _getUserLocationAndAddress() async {
    ...
    try {
      ...
      Navigator.pushNamed(context, DriversAppPickupLocationMapRoute);
    } catch (e) {}
  }
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText:
                          "What's the starting location for ${glb.subCategoryName}?",
...
//https://developers.google.com/maps/documentation/places/web-service/details#json
                        if (responseApi["status"] == "OK") {
                          ...
                          Navigator.pushNamed(
                              context, DriversAppPickupLocationMapRoute);
                        } else {
                          if (kDebugMode) {
