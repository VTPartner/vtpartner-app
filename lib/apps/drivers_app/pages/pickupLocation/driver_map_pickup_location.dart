...
class DriverMapPickupLocationScreen extends StatefulWidget {
  const DriverMapPickupLocationScreen({super.key});

  @override
  State<DriverMapPickupLocationScreen> createState() =>
      _DriverMapPickupLocationScreenState();
}

class _DriverMapPickupLocationScreenState
    extends State<DriverMapPickupLocationScreen> {
  ...
  Future<void> getAddressFromLatLng(double lat, double lng) async {
    ...
    try {
      ...
      // print("New Starting Location::$humanReadableAddress");
  ...
  void initState() {
    ...
    getSenderDetails();
    print("init Starting Location map");
                  ...
                  children: [
                    ...
                    _showBottomSheet
                        ? Positioned(
                            ...
                            child: CustomTooltip(
                                message: 'This is Drivers Starting Location'))
                        : SizedBox(),
                    SafeArea(
                      child: Padding(
  ...
  savePickupLocationDetails() async {
    ...
    if (_latitude != 0.0 || _longitude != 0.0) {
      ...
      Navigator.pushNamed(context, DriversAppDropLocationSearchRoute);
    } else {
      print("LatLng Error");
    }
  }
