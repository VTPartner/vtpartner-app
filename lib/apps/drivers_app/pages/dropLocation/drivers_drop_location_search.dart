...
class DriversDropLocationScreen extends StatefulWidget {
  const DriversDropLocationScreen({super.key});

  @override
  State<DriversDropLocationScreen> createState() =>
      _DriversDropLocationScreenState();
}

class _DriversDropLocationScreenState extends State<DriversDropLocationScreen> {
  ...
  Future<void> _getUserLocationAndAddress() async {
    ...
    try {
      ...
      Navigator.pushNamed(context, DriversAppDropLocationMapRoute);
    } catch (e) {}
  }
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      HeadingText(title: 'Select Driver Booking Addresses'),
                    ],
                  ),
                ),
                Container(
                                          ...
                                          child: InkWell(
                                            onTap: () {
                                              Navigator.pushNamed(context,
                                                  DriversAppPickupLocationSearchRoute);
                                            },
                                            borderRadius:
                                    ...
                                    child: Container(
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText:
                                              "Please specify the destination location for the driver.",
...
//https://developers.google.com/maps/documentation/places/web-service/details#json
                              if (responseApi["status"] == "OK") {
                                ...
                                Navigator.pushNamed(
                                    context, DriversAppDropLocationMapRoute);
                              } else {
                                if (kDebugMode) {
