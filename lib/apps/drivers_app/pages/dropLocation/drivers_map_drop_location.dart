...
class DriversMapDropLocationScreen extends StatefulWidget {
  const DriversMapDropLocationScreen({super.key});

  @override
  State<DriversMapDropLocationScreen> createState() =>
      _DriversMapDropLocationScreenState();
}

class _DriversMapDropLocationScreenState
    extends State<DriversMapDropLocationScreen> {
  ...
  void initState() {
    ...
    getReceiverDetails();
    print("Init Destination Location");
  ...
  onCameraMove(CameraPosition? position) {
    ...
    if (position != null) {
      ...
      _debounce = Timer(const Duration(seconds: 1), () {
        ...
        print("Destination location setting here");
        // checkServiceAvailable();
      });
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        ...
                        child: CustomTooltip(
                            message: "This is Driver's Destination Location")),
                    SafeArea(
                      child: Padding(
  ...
  saveDropLocationDetails() async {
    ...
    if (_latitude != 0.0 || _longitude != 0.0) {
      ...
      Navigator.pushReplacementNamed(context, DriversAppPickToDropRoute);
    } else {
      print("LatLng Error");
    }
  }
