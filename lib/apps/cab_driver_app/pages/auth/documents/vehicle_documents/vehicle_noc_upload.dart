...
class CabAgentVehicleNOCUpload extends StatefulWidget {
  const CabAgentVehicleNOCUpload({super.key});

  @override
  State<CabAgentVehicleNOCUpload> createState() =>
      _CabAgentVehicleNOCUploadState();
}

class _CabAgentVehicleNOCUploadState extends State<CabAgentVehicleNOCUpload> {
  File? _nocImage;
  String? previousNOC;
  ...
  Future<void> _setupCameraController() async {
    ...
    previousNOC = pref.getString("cab_agent_noc_photo_url");
    previousNOCNo = pref.getString("cab_agent_noc_no");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("cab_agent_noc_photo_url", retUrl);
  ...
  Future<void> saveRCDetails() async {
    ...
    String? savedNOCNo = pref.getString("cab_agent_noc_no");
    previousNOC = pref.getString("cab_agent_noc_photo_url");
    ...
    if (isNewEntry || savedNOCNo != nocNo) {
      await pref.setString("cab_agent_noc_no", nocNo);
    }
