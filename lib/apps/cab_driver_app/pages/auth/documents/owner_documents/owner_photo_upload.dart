...
class CabAgentOwnerPhotoUpload extends StatefulWidget {
  const CabAgentOwnerPhotoUpload({super.key});

  @override
  State<CabAgentOwnerPhotoUpload> createState() =>
      _CabAgentOwnerPhotoUploadState();
}

class _CabAgentOwnerPhotoUploadState extends State<CabAgentOwnerPhotoUpload> {
  ...
  Future<void> _setupCameraController() async {
    ...
    previousSelfie = pref.getString("cab_agent_owner_selfie_photo_url");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("cab_agent_owner_selfie_photo_url", retUrl);

        glb.showToast('Owner Selfie image uploaded successfully');
