...
class CabAgentVehicleDocumentationVerificationScreen extends StatefulWidget {
  const CabAgentVehicleDocumentationVerificationScreen({super.key});

  @override
  State<CabAgentVehicleDocumentationVerificationScreen> createState() =>
      _CabAgentVehicleDocumentationVerificationScreenState();
}

class _CabAgentVehicleDocumentationVerificationScreenState
    extends State<CabAgentVehicleDocumentationVerificationScreen> {
...
//     };
  ...
  Future<void> saveVehicleDetails() async {
    ...
    var cab_agent_vehicle_front_photo_url =
        pref.getString("cab_agent_vehicle_front_photo_url");
    var cab_agent_vehicle_back_photo_url =
        pref.getString("cab_agent_vehicle_back_photo_url");
    var cab_agent_vehicle_plate_front_photo_url =
        pref.getString("cab_agent_vehicle_plate_front_photo_url");
    var cab_agent_vehicle_plate_back_photo_url =
        pref.getString("cab_agent_vehicle_plate_back_photo_url");
    var cab_agent_rc_photo_url = pref.getString("cab_agent_rc_photo_url");
    var cab_agent_rc_no = pref.getString("cab_agent_rc_no");
    var cab_agent_insurance_photo_url =
        pref.getString("cab_agent_insurance_photo_url");
    var cab_agent_insurance_no = pref.getString("cab_agent_insurance_no");
    var cab_agent_noc_photo_url = pref.getString("cab_agent_noc_photo_url");
    var cab_agent_noc_no = pref.getString("cab_agent_noc_no");
    var cab_agent_puc_photo_url = pref.getString("cab_agent_puc_photo_url");
    var cab_agent_puc_no = pref.getString("cab_agent_puc_no");
    ...
    if (cab_agent_vehicle_plate_front_photo_url == null ||
        cab_agent_vehicle_plate_front_photo_url.isEmpty) {
      glb.showToast("Please provide your Vehicle Plate Front Picture");
      return;
    }
    if (cab_agent_vehicle_plate_back_photo_url == null ||
        cab_agent_vehicle_plate_back_photo_url.isEmpty) {
      glb.showToast("Please upload Vehicle Plate Back Picture");
      return;
    }
    if (cab_agent_rc_photo_url == null || cab_agent_rc_photo_url.isEmpty) {
      glb.showToast("Please upload RC Picture");
      return;
    }
    if (cab_agent_rc_no == null || cab_agent_rc_no.isEmpty) {
      glb.showToast("Please upload RC Number");
      return;
    }
    if (cab_agent_vehicle_front_photo_url == null ||
        cab_agent_vehicle_front_photo_url.isEmpty) {
      glb.showToast("Please upload Vehicle Front Picture");
      return;
    }
    if (cab_agent_vehicle_back_photo_url == null ||
        cab_agent_vehicle_back_photo_url.isEmpty) {
      glb.showToast("Please upload Vehicle Back Picture");
      return;
    }

    if (cab_agent_insurance_photo_url == null ||
        cab_agent_insurance_photo_url.isEmpty) {
      glb.showToast("Please upload Insurance picture");
      return;
    }
    if (cab_agent_insurance_no == null || cab_agent_insurance_no.isEmpty) {
      glb.showToast("Please upload Insurance Number");
      return;
    }
    if (cab_agent_noc_photo_url == null || cab_agent_noc_photo_url.isEmpty) {
      glb.showToast("Please upload NOC Picture");
      return;
    }
    if (cab_agent_noc_no == null || cab_agent_noc_no.isEmpty) {
      glb.showToast("Please upload NOC Number");
      return;
    }
    if (cab_agent_puc_photo_url == null || cab_agent_puc_photo_url.isEmpty) {
      glb.showToast("Please upload PUC Certificate Picture");
      return;
    }
    if (cab_agent_puc_no == null || cab_agent_puc_no.isEmpty) {
      glb.showToast("Please upload PUC Number");
      return;
    }

    pref.setString("cab_agent_driver_vehicle_no", vehicleNo);
    pref.setString("cab_agent_driver_vehicle_id", _selectedVehicleID!);
    pref.setString("cab_agent_driver_vehicle_fuel_type", _selectedFuel!);

    Navigator.pushNamed(context, CabAgentOwnerDetailsRoute);
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              documentStyle(() {
                Navigator.pushNamed(context, CabAgentVehicleImagesUploadRoute);
              ...
              documentStyle(() {
                Navigator.pushNamed(
                    context, CabAgentVehiclePlateImagesUploadRoute);
              ...
              documentStyle(() {
                Navigator.pushNamed(context, CabAgentRCUploadRoute);
              }, Icons.verified, 'Registration Certificate (RC)',
                  'Proof of vehicle ownership and registration', width),
              Divider(
                color: Colors.grey,
                thickness: 0.3,
                indent: 30,
              ...
              documentStyle(() {
                Navigator.pushNamed(context, CabAgentInsuranceUploadRoute);
              ...
              documentStyle(() {
                Navigator.pushNamed(context, CabAgentNOCUploadRoute);
              ...
              documentStyle(() {
                Navigator.pushNamed(context, CabAgentPUCUploadRoute);
              }, Icons.air_rounded, 'Pollution Under Control (PUC) Certificate',
                  'Proof that the vehicle meets emission standards.', width),
              Divider(
                color: Colors.grey,
                thickness: 0.3,
                indent: 30,
