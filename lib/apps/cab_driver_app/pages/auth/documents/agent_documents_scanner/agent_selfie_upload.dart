...
class CabAgentSelfieUpload extends StatefulWidget {
  const CabAgentSelfieUpload({super.key});

  @override
  State<CabAgentSelfieUpload> createState() => _CabAgentSelfieUploadState();
}

class _CabAgentSelfieUploadState extends State<CabAgentSelfieUpload> {
  ...
  Future<void> _setupCameraController() async {
    ...
    previousSelfie = pref.getString("cab_agent_selfie_photo_url");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("cab_agent_selfie_photo_url", retUrl);
