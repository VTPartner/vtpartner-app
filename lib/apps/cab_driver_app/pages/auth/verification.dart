...
class CabDriverOtpVerificationScreen extends StatefulWidget {
  const CabDriverOtpVerificationScreen({super.key});

  @override
  State<CabDriverOtpVerificationScreen> createState() =>
      _CabDriverOtpVerificationScreenState();
}

class _CabDriverOtpVerificationScreenState
    extends State<CabDriverOtpVerificationScreen> {
