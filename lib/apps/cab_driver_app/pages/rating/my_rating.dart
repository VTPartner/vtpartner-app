...
class CabDriverRatingScreen extends StatefulWidget {
  const CabDriverRatingScreen({super.key});

  @override
  State<CabDriverRatingScreen> createState() => _CabDriverRatingScreenState();
}

class _CabDriverRatingScreenState extends State<CabDriverRatingScreen> {
