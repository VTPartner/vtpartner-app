...
class CabDriverRideScreen extends StatefulWidget {
  const CabDriverRideScreen({super.key});

  @override
  State<CabDriverRideScreen> createState() => _CabDriverRideScreenState();
}

class _CabDriverRideScreenState extends State<CabDriverRideScreen> {
