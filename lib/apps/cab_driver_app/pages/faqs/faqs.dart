...
class CabDriverFAQsScreen extends StatefulWidget {
  const CabDriverFAQsScreen({super.key});

  @override
  State<CabDriverFAQsScreen> createState() => _CabDriverFAQsScreenState();
}

class _CabDriverFAQsScreenState extends State<CabDriverFAQsScreen> {
  final faqList = [
    {
      "title": "Sign in Issue",
