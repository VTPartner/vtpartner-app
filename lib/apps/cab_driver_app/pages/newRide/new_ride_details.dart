...
class CabRiderNewRideDetails extends StatefulWidget {
  const CabRiderNewRideDetails({super.key});

  @override
  State<CabRiderNewRideDetails> createState() => _CabRiderNewRideDetailsState();
}

class _CabRiderNewRideDetailsState extends State<CabRiderNewRideDetails> {
