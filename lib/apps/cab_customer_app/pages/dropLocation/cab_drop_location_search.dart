...
class CabDropLocationSearch extends StatefulWidget {
  const CabDropLocationSearch({super.key});

  @override
  State<CabDropLocationSearch> createState() => _CabDropLocationSearchState();
}

class _CabDropLocationSearchState extends State<CabDropLocationSearch> {
  ...
  Future<void> _getUserLocationAndAddress() async {
    ...
    try {
      ...
      Navigator.pushNamed(context, CabLocateOnMapDestinationLocationRoute);
    } catch (e) {}
  }
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      HeadingText(title: 'Select Cab Booking Addresses'),
                    ],
                  ),
                ),
                Container(
...
//https://developers.google.com/maps/documentation/places/web-service/details#json
                              if (responseApi["status"] == "OK") {
                                ...
                                Navigator.pushNamed(context,
                                    CabLocateOnMapDestinationLocationRoute);
                              } else {
                                if (kDebugMode) {
