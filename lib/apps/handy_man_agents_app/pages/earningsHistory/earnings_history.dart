...
class HandyManAgentEarningHistory extends StatefulWidget {
  const HandyManAgentEarningHistory({super.key});

  @override
  State<HandyManAgentEarningHistory> createState() =>
      _HandyManAgentEarningHistoryState();
}

class _HandyManAgentEarningHistoryState
    extends State<HandyManAgentEarningHistory> {
