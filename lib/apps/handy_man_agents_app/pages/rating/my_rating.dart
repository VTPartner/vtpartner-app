...
class HandyManAgentRatingScreen extends StatefulWidget {
  const HandyManAgentRatingScreen({super.key});

  @override
  State<HandyManAgentRatingScreen> createState() =>
      _HandyManAgentRatingScreenState();
}

class _HandyManAgentRatingScreenState extends State<HandyManAgentRatingScreen> {
