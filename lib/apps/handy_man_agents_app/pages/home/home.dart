...
class HandyManAgentHomeScreen extends StatefulWidget {
  const HandyManAgentHomeScreen({super.key, this.isonline});

  final bool? isonline;

  @override
  State<HandyManAgentHomeScreen> createState() =>
      _HandyManAgentHomeScreenState();
}

class _HandyManAgentHomeScreenState extends State<HandyManAgentHomeScreen> {
