...
class HandyManAgentOtpVerificationScreen extends StatefulWidget {
  const HandyManAgentOtpVerificationScreen({super.key});

  @override
  State<HandyManAgentOtpVerificationScreen> createState() =>
      _HandyManAgentOtpVerificationScreenState();
}

class _HandyManAgentOtpVerificationScreenState
    extends State<HandyManAgentOtpVerificationScreen> {
