...
class HandyManAgentAadharCardUploadScreen extends StatefulWidget {
  const HandyManAgentAadharCardUploadScreen({super.key});

  @override
  State<HandyManAgentAadharCardUploadScreen> createState() =>
      _HandyManAgentAadharCardUploadScreenState();
}

class _HandyManAgentAadharCardUploadScreenState
    extends State<HandyManAgentAadharCardUploadScreen> {
  File? _aadharFront;
  File? _aadharBack;
  ...
  Future<void> _setupCameraController() async {
    ...
    if (handy_man_agent_aadhar_no != null &&
        handy_man_agent_aadhar_no!.isNotEmpty) {
      aadharCardNoTextEdit.text = handy_man_agent_aadhar_no;
    }
      ...
      if (response.statusCode == 200) {
        ...
        if (isFront) {
          await pref.setString(
              "handy_man_agent_aadhar_front_photo_url", retUrl);
        } else {
          await pref.setString("handy_man_agent_aadhar_back_photo_url", retUrl);
        }

        pref.setString("handy_man_agent_aadhar_no",
  ...
  Future<void> saveAadharDetails() async {
    ...
    String? savedAadharNo = pref.getString("handy_man_agent_aadhar_no");
    previousAadharFront =
        pref.getString("handy_man_agent_aadhar_front_photo_url");
    previousAadharBack =
        pref.getString("handy_man_agent_aadhar_back_photo_url");
    ...
    if (isNewEntry || savedAadharNo != aadharNo) {
      await pref.setString("handy_man_agent_aadhar_no", aadharNo);
    }
