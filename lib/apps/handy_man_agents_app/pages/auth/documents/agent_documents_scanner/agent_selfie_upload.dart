...
class HandyManAgentSelfieUpload extends StatefulWidget {
  const HandyManAgentSelfieUpload({super.key});

  @override
  State<HandyManAgentSelfieUpload> createState() =>
      _HandyManAgentSelfieUploadState();
}

class _HandyManAgentSelfieUploadState extends State<HandyManAgentSelfieUpload> {
  ...
  Future<void> _setupCameraController() async {
    ...
    previousSelfie = pref.getString("handy_man_agent_selfie_photo_url");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("handy_man_agent_selfie_photo_url", retUrl);
