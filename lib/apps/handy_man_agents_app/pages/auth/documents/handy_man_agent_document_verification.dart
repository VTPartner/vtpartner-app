...
class HandyManAgentDocumentVerificationScreen extends StatefulWidget {
  const HandyManAgentDocumentVerificationScreen({super.key});

  @override
  State<HandyManAgentDocumentVerificationScreen> createState() =>
      _HandyManAgentDocumentVerificationScreenState();
}

class _HandyManAgentDocumentVerificationScreenState
    extends State<HandyManAgentDocumentVerificationScreen> {
...
//     };
  ...
  Future<void> saveDriverDetails() async {
    ...
    var handy_man_agent_aadhar_front_photo_url =
        pref.getString("handy_man_agent_aadhar_front_photo_url");
    var handy_man_agent_aadhar_back_photo_url =
        pref.getString("handy_man_agent_aadhar_back_photo_url");
    var handy_man_agent_aadhar_no = pref.getString("handy_man_agent_aadhar_no");
    var handy_man_agent_license_front_photo_url =
        pref.getString("handy_man_agent_license_front_photo_url");
    var handy_man_agent_license_back_photo_url =
        pref.getString("handy_man_agent_license_back_photo_url");
    var handy_man_agent_license_no =
        pref.getString("handy_man_agent_license_no");
    var handy_man_agent_pan_no = pref.getString("handy_man_agent_pan_no");
    var handy_man_agent_pan_front_photo_url =
        pref.getString("handy_man_agent_pan_front_photo_url");
    var handy_man_agent_pan_back_photo_url =
        pref.getString("handy_man_agent_pan_back_photo_url");
    var handy_man_agent_selfie_photo_url =
        pref.getString("handy_man_agent_selfie_photo_url");
    ...
    if (handy_man_agent_license_front_photo_url == null ||
        handy_man_agent_license_front_photo_url.isEmpty) {
      glb.showToast("Please upload Driving License Front Picture");
      return;
    }
    if (handy_man_agent_license_back_photo_url == null ||
        handy_man_agent_license_back_photo_url.isEmpty) {
      glb.showToast("Please upload Driving License Back Picture");
      return;
    }
    if (handy_man_agent_license_no == null ||
        handy_man_agent_license_no.isEmpty) {
      glb.showToast("Please upload Driving License Number");
      return;
    }
    if (handy_man_agent_aadhar_front_photo_url == null ||
        handy_man_agent_aadhar_front_photo_url.isEmpty) {
      glb.showToast("Please upload Aadhar Front Picture");
      return;
    }
    if (handy_man_agent_aadhar_back_photo_url == null ||
        handy_man_agent_aadhar_back_photo_url.isEmpty) {
      glb.showToast("Please upload Aadhar Back Picture");
      return;
    }
    if (handy_man_agent_aadhar_no == null ||
        handy_man_agent_aadhar_no.isEmpty) {
      glb.showToast("Please provide your Aadhar Number");
      return;
    }
    if (handy_man_agent_pan_no == null || handy_man_agent_pan_no.isEmpty) {
      glb.showToast("Please upload PAN Number");
      return;
    }
    if (handy_man_agent_pan_front_photo_url == null ||
        handy_man_agent_pan_front_photo_url.isEmpty) {
      glb.showToast("Please upload PAN Front Picture");
      return;
    }
    if (handy_man_agent_pan_back_photo_url == null ||
        handy_man_agent_pan_back_photo_url.isEmpty) {
      glb.showToast("Please upload PAN Back Picture");
      return;
    }
    if (handy_man_agent_selfie_photo_url == null ||
        handy_man_agent_selfie_photo_url.isEmpty) {
      glb.showToast("Please upload your selfie");
      return;
    }

    pref.setString("handy_man_agent_driver_name", driverName);
    pref.setString("handy_man_agent_driver_address", driverAddress);
    pref.setString("handy_man_agent_driver_city_id", _selectedCityID!);
    pref.setString("handy_man_agent_driver_gender", _selectedGender!);
