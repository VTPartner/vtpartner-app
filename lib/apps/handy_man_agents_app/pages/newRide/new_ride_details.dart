...
class HandyManAgentNewRideDetails extends StatefulWidget {
  const HandyManAgentNewRideDetails({super.key});

  @override
  State<HandyManAgentNewRideDetails> createState() =>
      _HandyManAgentNewRideDetailsState();
}

class _HandyManAgentNewRideDetailsState
    extends State<HandyManAgentNewRideDetails> {
