...
class DriverAgentFAQsScreen extends StatefulWidget {
  const DriverAgentFAQsScreen({super.key});

  @override
  State<DriverAgentFAQsScreen> createState() => _DriverAgentFAQsScreenState();
}

class _DriverAgentFAQsScreenState extends State<DriverAgentFAQsScreen> {
  final faqList = [
    {
      "title": "Sign in Issue",
