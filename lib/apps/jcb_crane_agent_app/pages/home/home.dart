...
class JcbCraneAgentHomeScreen extends StatefulWidget {
  const JcbCraneAgentHomeScreen({super.key, this.isonline});

  final bool? isonline;

  @override
  State<JcbCraneAgentHomeScreen> createState() =>
      _JcbCraneAgentHomeScreenState();
}

class _JcbCraneAgentHomeScreenState extends State<JcbCraneAgentHomeScreen> {
