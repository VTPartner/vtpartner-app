...
class JcbCraneAgentOtpVerificationScreen extends StatefulWidget {
  const JcbCraneAgentOtpVerificationScreen({super.key});

  @override
  State<JcbCraneAgentOtpVerificationScreen> createState() =>
      _JcbCraneAgentOtpVerificationScreenState();
}

class _JcbCraneAgentOtpVerificationScreenState
    extends State<JcbCraneAgentOtpVerificationScreen> {
