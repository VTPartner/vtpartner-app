...
class JcbCraneDriverAgentAadharCardUploadScreen extends StatefulWidget {
  const JcbCraneDriverAgentAadharCardUploadScreen({super.key});

  @override
  State<JcbCraneDriverAgentAadharCardUploadScreen> createState() =>
      _JcbCraneDriverAgentAadharCardUploadScreenState();
}

class _JcbCraneDriverAgentAadharCardUploadScreenState
    extends State<JcbCraneDriverAgentAadharCardUploadScreen> {
  File? _aadharFront;
  File? _aadharBack;
  ...
  Future<void> _setupCameraController() async {
    ...
    if (jcb_crane_driver_agent_aadhar_no != null &&
        jcb_crane_driver_agent_aadhar_no!.isNotEmpty) {
      aadharCardNoTextEdit.text = jcb_crane_driver_agent_aadhar_no;
    }
      ...
      if (response.statusCode == 200) {
        ...
        if (isFront) {
          await pref.setString(
              "jcb_crane_driver_agent_aadhar_front_photo_url", retUrl);
        } else {
          await pref.setString(
              "jcb_crane_driver_agent_aadhar_back_photo_url", retUrl);
        }

        pref.setString("jcb_crane_driver_agent_aadhar_no",
  ...
  Future<void> saveAadharDetails() async {
    ...
    String? savedAadharNo = pref.getString("jcb_crane_driver_agent_aadhar_no");
    previousAadharFront =
        pref.getString("jcb_crane_driver_agent_aadhar_front_photo_url");
    previousAadharBack =
        pref.getString("jcb_crane_driver_agent_aadhar_back_photo_url");
    ...
    if (isNewEntry || savedAadharNo != aadharNo) {
      await pref.setString("jcb_crane_driver_agent_aadhar_no", aadharNo);
    }
