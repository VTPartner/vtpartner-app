...
class JcbCraneDriverAgentSelfieUpload extends StatefulWidget {
  const JcbCraneDriverAgentSelfieUpload({super.key});

  @override
  State<JcbCraneDriverAgentSelfieUpload> createState() =>
      _JcbCraneDriverAgentSelfieUploadState();
}

class _JcbCraneDriverAgentSelfieUploadState
    extends State<JcbCraneDriverAgentSelfieUpload> {
  ...
  Future<void> _setupCameraController() async {
    ...
    previousSelfie = pref.getString("jcb_crane_driver_agent_selfie_photo_url");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("jcb_crane_driver_agent_selfie_photo_url", retUrl);
