...
class JcbCraneAgentRechargeHistoryScreen extends StatefulWidget {
  const JcbCraneAgentRechargeHistoryScreen({super.key});

  @override
  State<JcbCraneAgentRechargeHistoryScreen> createState() =>
      _JcbCraneAgentRechargeHistoryScreenState();
}

class _JcbCraneAgentRechargeHistoryScreenState
    extends State<JcbCraneAgentRechargeHistoryScreen> {
