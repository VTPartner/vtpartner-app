...
class JcbCraneAgentRideScreen extends StatefulWidget {
  const JcbCraneAgentRideScreen({super.key});

  @override
  State<JcbCraneAgentRideScreen> createState() =>
      _JcbCraneAgentRideScreenState();
}

class _JcbCraneAgentRideScreenState extends State<JcbCraneAgentRideScreen> {
