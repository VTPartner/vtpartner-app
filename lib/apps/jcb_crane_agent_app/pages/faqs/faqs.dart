...
class JcbCraneAgentFAQsScreen extends StatefulWidget {
  const JcbCraneAgentFAQsScreen({super.key});

  @override
  State<JcbCraneAgentFAQsScreen> createState() =>
      _JcbCraneAgentFAQsScreenState();
}

class _JcbCraneAgentFAQsScreenState extends State<JcbCraneAgentFAQsScreen> {
  final faqList = [
    {
      "title": "Sign in Issue",
