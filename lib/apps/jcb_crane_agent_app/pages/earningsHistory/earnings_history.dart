...
class JcbCraneAgentEarningHistory extends StatefulWidget {
  const JcbCraneAgentEarningHistory({super.key});

  @override
  State<JcbCraneAgentEarningHistory> createState() =>
      _JcbCraneAgentEarningHistoryState();
}

class _JcbCraneAgentEarningHistoryState
    extends State<JcbCraneAgentEarningHistory> {
