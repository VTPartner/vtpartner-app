...
class JcbCraneAgentRechargeHomeScreen extends StatefulWidget {
  const JcbCraneAgentRechargeHomeScreen({super.key});

  @override
  State<JcbCraneAgentRechargeHomeScreen> createState() =>
      _JcbCraneAgentRechargeHomeScreenState();
}

class _JcbCraneAgentRechargeHomeScreenState
    extends State<JcbCraneAgentRechargeHomeScreen> {
