...
class JcbCraneAgentNewRideDetails extends StatefulWidget {
  const JcbCraneAgentNewRideDetails({super.key});

  @override
  State<JcbCraneAgentNewRideDetails> createState() =>
      _JcbCraneAgentNewRideDetailsState();
}

class _JcbCraneAgentNewRideDetailsState
    extends State<JcbCraneAgentNewRideDetails> {
