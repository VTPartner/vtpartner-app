...
class HandyManWorkLocationSearchScreen extends StatefulWidget {
  const HandyManWorkLocationSearchScreen({super.key});

  @override
  State<HandyManWorkLocationSearchScreen> createState() =>
      _HandyManWorkLocationSearchScreenState();
}

class _HandyManWorkLocationSearchScreenState
    extends State<HandyManWorkLocationSearchScreen> {
  ...
  Future<void> _getUserLocationAndAddress() async {
    ...
    try {
      ...
      Navigator.pushNamed(context, HandyManAppWorkLocationMapRoute);
    } catch (e) {}
  }
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText:
                          'Provide the work location for ${glb.subCategoryName}',
...
//https://developers.google.com/maps/documentation/places/web-service/details#json
                        if (responseApi["status"] == "OK") {
                          ...
                          Navigator.pushNamed(
                              context, HandyManAppWorkLocationMapRoute);
                        } else {
                          if (kDebugMode) {
