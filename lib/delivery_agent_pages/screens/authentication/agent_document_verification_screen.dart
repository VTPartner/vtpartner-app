...
//     };
  ...
  Future<void> saveDriverDetails() async {
    ...
    var aadhar_front_photo_url = pref.getString("aadhar_front_photo_url");
    var aadhar_back_photo_url = pref.getString("aadhar_back_photo_url");
    var aadhar_no = pref.getString("aadhar_no");
    var license_front_photo_url = pref.getString("license_front_photo_url");
    var license_back_photo_url = pref.getString("license_back_photo_url");
    var license_no = pref.getString("license_no");
    var pan_no = pref.getString("pan_no");
    var pan_front_photo_url = pref.getString("pan_front_photo_url");
    var pan_back_photo_url = pref.getString("pan_back_photo_url");
    var selfie_photo_url = pref.getString("selfie_photo_url");
    ...
    if (license_front_photo_url == null || license_front_photo_url.isEmpty) {
      glb.showToast("Please upload Driving License Front Picture");
      return;
    }
    if (license_back_photo_url == null || license_back_photo_url.isEmpty) {
    ...
    if (aadhar_front_photo_url == null || aadhar_front_photo_url.isEmpty) {
      glb.showToast("Please upload Aadhar Front Picture");
      return;
    }
    if (aadhar_back_photo_url == null || aadhar_back_photo_url.isEmpty) {
      glb.showToast("Please upload Aadhar Back Picture");
      return;
    }
    if (aadhar_no == null || aadhar_no.isEmpty) {
    ...
    if (pan_front_photo_url == null || pan_front_photo_url.isEmpty) {
      glb.showToast("Please upload PAN Front Picture");
      return;
    }
    if (pan_back_photo_url == null || pan_back_photo_url.isEmpty) {
      glb.showToast("Please upload PAN Back Picture");
      return;
    }
    if (selfie_photo_url == null || selfie_photo_url.isEmpty) {
      glb.showToast("Please upload your selfie");
      return;
    }

    pref.setString("driver_name", driverName);
    pref.setString("driver_address", driverAddress);
    pref.setString("driver_city_id", _selectedCityID!);
    pref.setString("driver_gender", _selectedGender!);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              documentStyle(
                  () {
                Navigator.pushNamed(context, DrivingLicenseUploadRoute);
              ...
              documentStyle(() {
                ...
                Navigator.pushNamed(context, AadharCardUploadRoute);
              ...
              documentStyle(
                  () {
                Navigator.pushNamed(context, PanCardUploadRoute);
              ...
              documentStyle(() {
                Navigator.pushNamed(context, OwnerSelfieUploadRoute);
              }, Icons.camera, 'Selfie'),
              Divider(
                color: Colors.grey,
                thickness: 0.3,
