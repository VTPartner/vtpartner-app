...
class OwnerPhotoUpload extends StatefulWidget {
  const OwnerPhotoUpload({super.key});

  @override
  State<OwnerPhotoUpload> createState() => _OwnerPhotoUploadState();
}

class _OwnerPhotoUploadState extends State<OwnerPhotoUpload> {
  ...
  Future<void> _setupCameraController() async {
    ...
    previousSelfie = pref.getString("owner_selfie_photo_url");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("owner_selfie_photo_url", retUrl);
