...
class OwnerSelfieUpload extends StatefulWidget {
  const OwnerSelfieUpload({super.key});

  @override
  State<OwnerSelfieUpload> createState() => _OwnerSelfieUploadState();
}

class _OwnerSelfieUploadState extends State<OwnerSelfieUpload> {
  ...
  Future<void> _setupCameraController() async {
    ...
    previousSelfie = pref.getString("selfie_photo_url");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("selfie_photo_url", retUrl);
