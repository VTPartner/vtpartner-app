...
class AadharCardUploadScreen extends StatefulWidget {
  const AadharCardUploadScreen({super.key});

  @override
  State<AadharCardUploadScreen> createState() => _AadharCardUploadScreenState();
}

class _AadharCardUploadScreenState extends State<AadharCardUploadScreen> {
  File? _aadharFront;
  File? _aadharBack;
  ...
  Future<void> _setupCameraController() async {
    ...
    previousAadharFront = pref.getString("aadhar_front_photo_url");
    previousAadharBack = pref.getString("aadhar_back_photo_url");
    var aadhar_no = pref.getString("aadhar_no");
    if (aadhar_no != null && aadhar_no!.isNotEmpty) {
      aadharCardNoTextEdit.text = aadhar_no;
    }
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (isFront) {
          await pref.setString("aadhar_front_photo_url", retUrl);
        } else {
          await pref.setString("aadhar_back_photo_url", retUrl);
        }

        pref.setString(
            "aadhar_no", aadharCardNoTextEdit.text.toString().trim());
        glb.showToast(
  ...
  Future<void> saveAadharDetails() async {
    ...
    String? savedAadharNo = pref.getString("aadhar_no");
    previousAadharFront = pref.getString("aadhar_front_photo_url");
    previousAadharBack = pref.getString("aadhar_back_photo_url");
    ...
    if (isNewEntry || savedAadharNo != aadharNo) {
      await pref.setString("aadhar_no", aadharNo);
    }
