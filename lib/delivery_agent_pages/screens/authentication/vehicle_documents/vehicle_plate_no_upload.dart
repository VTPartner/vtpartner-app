...
class VehiclePlateNoUpload extends StatefulWidget {
  const VehiclePlateNoUpload({super.key});

  @override
  State<VehiclePlateNoUpload> createState() => _VehiclePlateNoUploadState();
}

class _VehiclePlateNoUploadState extends State<VehiclePlateNoUpload> {
  ...
  Future<void> _setupCameraController() async {
    ...
    previousVehiclePlateFront = pref.getString("vehicle_plate_front_photo_url");
    previousVehiclePlateBack = pref.getString("vehicle_plate_back_photo_url");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (isFront) {
          await pref.setString("vehicle_plate_front_photo_url", retUrl);
        } else {
          await pref.setString("vehicle_plate_back_photo_url", retUrl);
        }
