...
class VehicleRCUpload extends StatefulWidget {
  const VehicleRCUpload({super.key});

  @override
  State<VehicleRCUpload> createState() => _VehicleRCUploadState();
}

class _VehicleRCUploadState extends State<VehicleRCUpload> {
  File? _rcImage;
  String? previousRC;
  String? previousRCNo;
  ...
  Future<void> _setupCameraController() async {
    ...
    previousRC = pref.getString("rc_photo_url");
    previousRCNo = pref.getString("rc_no");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("rc_photo_url", retUrl);
  ...
  Future<void> saveRCDetails() async {
    ...
    String? savedRCNo = pref.getString("rc_no");
    previousRC = pref.getString("rc_photo_url");
    ...
    if (isNewEntry || savedRCNo != rcNo) {
      await pref.setString("rc_no", rcNo);
    }
