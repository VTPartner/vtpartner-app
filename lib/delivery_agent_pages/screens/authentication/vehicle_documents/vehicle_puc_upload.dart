...
class VehiclePUCUpload extends StatefulWidget {
  const VehiclePUCUpload({super.key});

  @override
  State<VehiclePUCUpload> createState() => _VehiclePUCUploadState();
}

class _VehiclePUCUploadState extends State<VehiclePUCUpload> {
  File? _pucImage;
  String? previousPUC;
  ...
  Future<void> _setupCameraController() async {
    ...
    previousPUC = pref.getString("puc_photo_url");
    previousPUCNo = pref.getString("puc_no");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("puc_photo_url", retUrl);
  ...
  Future<void> saveRCDetails() async {
    ...
    String? savedPUCNo = pref.getString("puc_no");
    previousPUC = pref.getString("puc_photo_url");
    ...
    if (isNewEntry || savedPUCNo != pucNo) {
      await pref.setString("puc_no", pucNo);
    }
