...
class VehicleImageUpload extends StatefulWidget {
  ...
  @override
  State<VehicleImageUpload> createState() => _VehicleImageUploadState();
}

class _VehicleImageUploadState extends State<VehicleImageUpload> {
  File? _vehicleFront;
  File? _vehicleBack;
  ...
  Future<void> _setupCameraController() async {
    ...
    previousVehicleFront = pref.getString("vehicle_front_photo_url");
    previousVehicleBack = pref.getString("vehicle_back_photo_url");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (isFront) {
          await pref.setString("vehicle_front_photo_url", retUrl);
        } else {
          await pref.setString("vehicle_back_photo_url", retUrl);
        }
