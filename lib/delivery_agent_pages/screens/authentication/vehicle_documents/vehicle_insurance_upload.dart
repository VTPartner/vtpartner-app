...
class _VehicleInsuranceUploadState extends State<VehicleInsuranceUpload> {
  ...
  Future<void> _setupCameraController() async {
    ...
    previousInsurance = pref.getString("insurance_photo_url");
    previousInsuranceNo = pref.getString("insurance_no");
  ...
  Future<void> _uploadImage(File image, bool isFront) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await pref.setString("insurance_photo_url", retUrl);
  ...
  Future<void> saveInsuranceDetails() async {
    ...
    String? savedInsuranceNo = pref.getString("insurance_no");
    previousInsurance = pref.getString("insurance_photo_url");
    ...
    if (isNewEntry || savedInsuranceNo != insuranceNo) {
      await pref.setString("insurance_no", insuranceNo);
    }
