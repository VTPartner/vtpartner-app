...
class CabUserLocationOnMapDestinationScreen extends StatefulWidget {
  const CabUserLocationOnMapDestinationScreen({super.key});

  @override
  State<CabUserLocationOnMapDestinationScreen> createState() =>
      _CabUserLocationOnMapDestinationScreenState();
}

class _CabUserLocationOnMapDestinationScreenState
    extends State<CabUserLocationOnMapDestinationScreen> {
          ...
          : Stack(
              children: [
                ...
                Positioned(
                    ...
                    child: CustomTooltip(message: 'Your Destination Location')),
                SafeArea(
                  child: Padding(
